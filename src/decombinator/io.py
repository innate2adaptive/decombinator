...
def cli_args():
    ...
    parser.add_argument(
        ...
        "--dontcount",
        action="store_true",
        help="Stop Decombinator printing a running count",
        required=False,
    )
    parser.add_argument(
        "-ex",
    ...
    parser.add_argument(
        ...
        "--percentlevdist",
        type=int,
        help="Percentage Levenshtein distance that is allowed to estimate whether two sequences within a barcode are \
        derived from the same originator molecule. Default = 10",
        required=False,
        default=10,
    )
    parser.add_argument(
        ...
        "--bcthreshold",
        type=int,
        help="Number of sequence edits that are allowed to consider two barcodes to be derived from same originator \
        during clustering. Default = 2.",
        required=False,
        default=2,
    )
    parser.add_argument(
        ...
        "--dontcheckinput",
        action="store_true",
        help="Override the inputfile sanity check",
        required=False,
    )
    parser.add_argument(
        "-bd",
    ...
    parser.add_argument(
        ...
        "--oligo",
        type=str,
        help='Choose experimental oligo for correct identification of spacers ["M13", "I8","I8_single] (default: M13)',
        required=True,
        default="m13",
    )
    parser.add_argument(
